                ...
                <form action="{{route("admin.technology.update", $technology)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="p-6 text-stone-900 dark:text-stone-100">
                        ...
                        <div>
                            ...
                            <x-text-input value="{{$technology->name}}" id="name" class="block mt-1 w-full hover:dark:border-zinc-600" type="text" name="name" required autofocus/>
                        ...
                        <div class="block mt-4">
                            ...
                            <textarea required name="presentation" id="presentation" class="border-zinc-300 dark:border-zinc-700 hover:dark:border-zinc-600 dark:bg-zinc-900 dark:text-zinc-300 focus:border-orange-500 dark:focus:border-orange-600 focus:ring-orange-500 dark:focus:ring-orange-600 rounded-md shadow-sm w-full">{{$technology->presentation}}</textarea>
                        ...
                        <div class="block mt-4">
                            ...
                            <x-input-label for="image" value="Image" class="mb-2"/>
                                ...
                                <div class="mb-2">
                                    <img src="{{Storage::url($technology->image)}}" alt="" width="200px">
                                </div>
